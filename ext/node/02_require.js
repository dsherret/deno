...
((window) => {
  ...
  Module.wrapper = [
    ...
    "(function (exports, require, module, __filename, __dirname, globalThis) { const { Buffer, clearImmediate, clearInterval, clearTimeout, global, process, setImmediate, setInterval, setTimeout, window } = globalThis; (function () {",
    "\n}).call(this); })",
  ];
