...
pub struct GraphData {
  ...
  npm_package_req_batches: NpmPackageReqBatches,
...
impl GraphData {
  ...
  /// Gets the batches of npm package requirements to install based on
  /// the structure of the module graph.
  pub fn npm_package_req_batches(&self) -> &NpmPackageReqBatches {
    &self.npm_package_req_batches
  }
  ...
  pub fn graph_segment(
    ...
    Some(Self {
      modules,
      npm_package_req_batches: self.npm_package_req_batches.clone(),
      referrer_map,
